...
export function ChatHeader({ agent, showButton, showImage, handleSidebarToggle }: { agent: any , showButton: boolean, showImage: boolean, handleSidebarToggle: () => void}) {
  return (
    <div className="sm:fixed sm:top-0 sm:left-0 sm:right-0 sm:z-50 border-b border-neutral-200 bg-white px-4 py-3 dark:border-neutral-800 dark:bg-neutral-900">
