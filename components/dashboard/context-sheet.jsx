...
export default function ContextSheet({ value, onChange, onSave, isSaving = false }) {
  return (
...
• Industry knowledge: 'Key terms and concepts in our field...'`}
      ...
      <div className="flex items-center justify-between gap-4">
        ...
        <Button
          ...
          onClick={onSave}
          disabled={isSaving}
          className="bg-white/10 hover:bg-white/20 border border-white/10 hover:border-white/20 text-white shrink-0"
        >
