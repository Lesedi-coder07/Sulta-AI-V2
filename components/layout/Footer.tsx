  ...
  return (
    <footer className="border-t border-white/10 bg-[#05070D] text-slate-300">
      <div className="mx-auto grid w-full max-w-7xl gap-10 px-4 py-14 sm:px-6 lg:grid-cols-[1.5fr_1fr_1fr] lg:px-8">
        <div>
          <p className="text-xs uppercase tracking-[0.2em] text-slate-400">Sulta AI Platform</p>
        ...
        <div>
          ...
          <ul className="mt-4 space-y-3 text-sm">
            <li>
              <a href="mailto:hello@sultatech.com" className="transition hover:text-white">
                hello@sultatech.com
              </a>
            </li>
            <li>
              <a href="https://sultatech.com/book" target="_blank" rel="noreferrer noopener" className="transition hover:text-white">
